...
if(document.cadastro.idAuditPlan.value=="")
	...
	{
	alert("Attention: Criterio Audit Document (.CSV) it's Mandatory!");
	return false;
	}
else
return true;
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                        <form class="form-inline" action="CriterionAuditImport.php" name="cadastro" method="post" enctype="multipart/form-data" onsubmit="return validaCampo(); return false;" style="justify-content: center;">
                    <span class="login100-form-title p-b-18">
                       Insert the Criterion Audit
                    </span>
